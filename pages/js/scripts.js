...
function OnInput() {
  ...
  if (box.scrollHeight > 210) {box.style.height = 'auto';} else {box.style.height = "200px";}
  
  box.rows = box.value.substr(0, box.selectionStart).split(/\r?\n|\r/).length;
}
...
var i = 0;
var txt = 'Write something...';
var speed = 30;

function typeWriter() {
    if (i < txt.length) {
      document.getElementById("text").placeholder += txt.charAt(i);
      i++;
